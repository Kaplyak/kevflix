    ...
    return <>
        ...
        <div className="bg">
            <div className="ml-5 lg:ml-20 mt-60 relative text-whiteflix">
                <h1 className="title text-3xl lg:text-8xl mb-5">{props.details.name}</h1>
                <h2 className="tagline text-xl lg:text-2xl ml-2 mb-3">{props.details.tagline}</h2>
                <div className="max-w-sm">
                    <div className="ml-2">
                        <p className="overview mb-2">{props.details.overview}</p>
                        <p className="runtime">Episode runtime: {props.details.episode_run_time} minutes</p>
                        <p className="score">Rating: {props.details.vote_average}</p>
                        <p className="mt-2">Seasons: {props.details.number_of_seasons}</p>
                        <p className="">Episodes: {props.details.number_of_episodes}</p>
